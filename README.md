...
Pythonのインストール不要です。[Releases](https://github.com/Ayato-AI-for-Auto/Transform_MovieToText/releases) から最新のインストーラーをダウンロードしてください。

**CPU版とGPU版の選び方:**
- **GPU版**: NVIDIA製GPUを搭載したPCをお使いの場合。文字起こしやAI要約の処理速度が劇的に高速になります。
- **CPU版**: GPU非搭載、またはNVIDIA製以外のGPUをお使いの場合。CPUのみで動作するため環境を選びませんが、処理時間はGPU版より長くなります。

1. ご自身の環境に合わせて CPU版 または GPU版 をダウンロード
